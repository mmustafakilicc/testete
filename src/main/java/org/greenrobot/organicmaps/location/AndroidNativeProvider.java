...
import static org.greenrobot.organicmaps.util.concurrency.UiThread.runLater;
...
class AndroidNativeProvider extends BaseLocationProvider
{
  ...
  {
    super(listener);
    mLocationManager = (LocationManager) OrganicMapsModule.get().getApplication().getSystemService(Context.LOCATION_SERVICE);
