...
import org.greenrobot.organicmaps.downloader.CountrySuggestFragment;
...
import org.greenrobot.organicmaps.sdk.search.SearchListener;
import org.greenrobot.organicmaps.sdk.search.SearchRecents;
import org.greenrobot.organicmaps.sdk.search.SearchResult;
                                    ...
                                    CategoriesAdapter.CategoriesUiListener
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_fragment_search, container, false);
  }
...

  {
    ...
    int lastSelectedTabPosition = SharedPrefUtils.INSTANCE.getLastSearchedTab(requireContext());
  ...
  void showAllResultsOnMap()
  {
    ...
    SearchEngine.INSTANCE.searchInteractive(
        query, isCategory(), !TextUtils.isEmpty(mInitialLocale)
               ? mInitialLocale : org.greenrobot.organicmaps.util.Language.getKeyboardLocale(requireContext()),
