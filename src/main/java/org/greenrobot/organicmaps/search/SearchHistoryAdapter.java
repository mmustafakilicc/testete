...
class SearchHistoryAdapter extends RecyclerView.Adapter<SearchHistoryAdapter.ViewHolder>
{
  ...
  public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type)
  {
    ...
    {
      case TYPE_ITEM:
        res = new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mn_org_map_item_search_recent, viewGroup, false));
        res.mText.setOnClickListener(v -> mSearchToolbarController.setQuery(res.mText.getText()));
        break;

      case TYPE_CLEAR:
        res = new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mn_org_map_item_search_clear_history, viewGroup, false));
      ...
      case TYPE_MY_POSITION:
        res = new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mn_org_map_item_search_my_position, viewGroup, false));
        res.mText.setOnClickListener(v -> {
