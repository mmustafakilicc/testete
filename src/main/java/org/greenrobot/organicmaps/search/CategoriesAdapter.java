...
import org.greenrobot.organicmaps.sdk.search.DisplayedCategories;
...
class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.ViewHolder>
{
                                           ...
                                           @NonNull String key)
  {
    ...
    String iconId = "mn_org_map_ic_" + key;
    if (isNightTheme)
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, @ViewType int viewType)
  {
    ...
    {
      view = mInflater.inflate(R.layout.mn_org_map_item_search_category, parent, false);
