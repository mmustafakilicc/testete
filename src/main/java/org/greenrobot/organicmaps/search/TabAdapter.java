...
class TabAdapter extends FragmentPagerAdapter
{
  ...
  private static class OnTabSelectedListenerForViewPager extends TabLayout.ViewPagerOnTabSelectedListener
  {
    ...
    {
      SharedPrefUtils.INSTANCE.setLastSearchedTab(mContext, tab.getPosition());
  ...
  private void attachTo(TabLayout tabs)
  {
    ...
    int lastSelectedTabPosition = SharedPrefUtils.INSTANCE.getLastSearchedTab(mPager.getContext());
