...
import org.greenrobot.organicmaps.widget.recycler.DotDividerItemDecoration;
import org.greenrobot.organicmaps.widget.recycler.MultilineLayoutManager;
...
final class RoutingBottomMenuController implements View.OnClickListener
{
                                      ...
                                      @Nullable RoutingBottomMenuListener listener)
  {
    ...
    TextView manageRouteButton = altitudeChartFrame.findViewById(R.id.btn__manage_route);
  ...
  void showAddStartFrame()
  {
    ...
    if (LocationHelper.from(mContext).getMyPosition() != null)
    {
      ...
      Drawable icon = ContextCompat.getDrawable(mContext, R.drawable.mn_org_map_ic_location_crosshair);
                                              ...
                                              @NonNull SpannableStringBuilder builder)
  {
    ...
    builder.setSpan(new TypefaceSpan(context.getResources().getString(R.string.mn_org_map_robotoMedium)),
                    0,
                    builder.length(),
