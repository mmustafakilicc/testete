    ...
    implements View.OnClickListener, ManageRouteAdapter.ManageRouteListener
{
  ...
  {
    View v = inflater.inflate(R.layout.mn_org_map_manage_route_bottom_sheet, container, false);
  ...
  public void onClick(View v)
  {
    ...
    else if (buttonId == R.id.image_my_location)
    {
      ...
      MapObject myLocation = OrganicMapsModule.get().getLocationHelper().getMyPosition();
