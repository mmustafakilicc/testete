...
public class SingleLaneInfo
{
  ...
  public enum LaneWay
  {
    NONE(R.drawable.mn_org_map_ic_turn_straight),
    REVERSE(R.drawable.mn_org_map_ic_turn_uleft),
    SHARP_LEFT(R.drawable.mn_org_map_ic_turn_left_sharp),
    LEFT(R.drawable.mn_org_map_ic_turn_left),
    SLIGHT_LEFT(R.drawable.mn_org_map_ic_turn_left_slight),
    MERGE_TO_RIGHT(R.drawable.mn_org_map_ic_turn_right_slight),
    THROUGH(R.drawable.mn_org_map_ic_turn_straight),
    MERGE_TO_LEFT(R.drawable.mn_org_map_ic_turn_left_slight),
    SLIGHT_RIGHT(R.drawable.mn_org_map_ic_turn_right_slight),
    RIGHT(R.drawable.mn_org_map_ic_turn_right),
    SHARP_RIGHT(R.drawable.mn_org_map_ic_turn_right_sharp);
