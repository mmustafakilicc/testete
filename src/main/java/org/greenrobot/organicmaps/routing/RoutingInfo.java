...
public class RoutingInfo
{
  ...
  {
    NO_TURN(R.drawable.mn_org_map_ic_turn_straight, 0),
    GO_STRAIGHT(R.drawable.mn_org_map_ic_turn_straight, 0),

    TURN_RIGHT(R.drawable.mn_org_map_ic_turn_right, R.drawable.mn_org_map_ic_then_right),
    TURN_SHARP_RIGHT(R.drawable.mn_org_map_ic_turn_right_sharp, R.drawable.mn_org_map_ic_then_right_sharp),
    TURN_SLIGHT_RIGHT(R.drawable.mn_org_map_ic_turn_right_slight, R.drawable.mn_org_map_ic_then_right_slight),

    TURN_LEFT(R.drawable.mn_org_map_ic_turn_left, R.drawable.mn_org_map_ic_then_left),
    TURN_SHARP_LEFT(R.drawable.mn_org_map_ic_turn_left_sharp, R.drawable.mn_org_map_ic_then_left_sharp),
    TURN_SLIGHT_LEFT(R.drawable.mn_org_map_ic_turn_left_slight, R.drawable.mn_org_map_ic_then_left_slight),

    U_TURN_LEFT(R.drawable.mn_org_map_ic_turn_uleft, R.drawable.mn_org_map_ic_then_uleft),
    U_TURN_RIGHT(R.drawable.mn_org_map_ic_turn_uright, R.drawable.mn_org_map_ic_then_uright),

    ENTER_ROUND_ABOUT(R.drawable.mn_org_map_ic_turn_round, R.drawable.mn_org_map_ic_then_round),
    LEAVE_ROUND_ABOUT(R.drawable.mn_org_map_ic_turn_round, R.drawable.mn_org_map_ic_then_round),
    STAY_ON_ROUND_ABOUT(R.drawable.mn_org_map_ic_turn_round, R.drawable.mn_org_map_ic_then_round),

    START_AT_THE_END_OF_STREET(0, 0),
    REACHED_YOUR_DESTINATION(R.drawable.mn_org_map_ic_turn_finish, R.drawable.mn_org_map_ic_then_finish),

    EXIT_HIGHWAY_TO_LEFT(R.drawable.mn_org_map_ic_exit_highway_to_left, R.drawable.mn_org_map_ic_then_exit_highway_to_left),
    EXIT_HIGHWAY_TO_RIGHT(R.drawable.mn_org_map_ic_exit_highway_to_right, R.drawable.mn_org_map_ic_then_exit_highway_to_right);
