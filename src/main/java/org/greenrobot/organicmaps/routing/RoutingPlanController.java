...
import org.greenrobot.organicmaps.util.WindowInsetUtils.PaddingInsetsListener;
import org.greenrobot.organicmaps.widget.RoutingToolbarButton;
import org.greenrobot.organicmaps.widget.ToolbarController;
import org.greenrobot.organicmaps.widget.WheelProgressView;
...
//    mProgressTaxi = (WheelProgressView) progressFrame.findViewById(R.id.progress_taxi);
    ...
    mAnimToggle = OrganicMapsModule.get().getApplication().getResources().getInteger(R.integer.mn_org_map_anim_default);
  ...
  {
    setupRouterButton(R.id.vehicle, R.drawable.mn_org_map_ic_car, this::onVehicleModeSelected);
    setupRouterButton(R.id.pedestrian, R.drawable.mn_org_map_ic_pedestrian, this::onPedestrianModeSelected);
//    setupRouterButton(R.id.taxi, R.drawable.ic_taxi, this::onTaxiModeSelected);
    setupRouterButton(R.id.transit, R.drawable.mn_org_map_ic_transit, this::onTransitModeSelected);
    setupRouterButton(R.id.bicycle, R.drawable.mn_org_map_ic_bike, this::onBicycleModeSelected);
    setupRouterButton(R.id.ruler, R.drawable.mn_org_map_ic_ruler_route, this::onRulerModeSelected);
  }
