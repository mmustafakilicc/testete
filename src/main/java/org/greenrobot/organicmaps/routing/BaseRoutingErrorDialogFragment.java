...
import org.greenrobot.organicmaps.adapter.DisabledChildSimpleExpandableListAdapter;
...
abstract class BaseRoutingErrorDialogFragment extends BaseMwmDialogFragment
{
  ...
  View buildSingleMapView(CountryItem map)
  {
    ...
    final View countryView = View.inflate(requireActivity(), R.layout.mn_org_map_dialog_missed_map, null);
  ...
  {
    @SuppressLint("InflateParams")
    final View countriesView = View.inflate(requireActivity(), R.layout.mn_org_map_dialog_missed_maps, null);
  ...
  private ExpandableListAdapter buildAdapter()
  {
    ...
    return new DisabledChildSimpleExpandableListAdapter(requireActivity(),
                                                        groups,
                                                        R.layout.mn_org_map_item_missed_map_group,
                                                        R.layout.mn_org_map_item_missed_map,
