...
public class SearchWheel implements View.OnClickListener
{
  ...
  {
    FUEL(R.id.search_fuel, R.drawable.mn_org_map_ic_routing_fuel_off, R.string.category_fuel),
    PARKING(R.id.search_parking, R.drawable.mn_org_map_ic_routing_parking_off, R.string.category_parking),
    EAT(R.id.search_eat, R.drawable.mn_org_map_ic_routing_eat_off, R.string.category_eat),
    FOOD(R.id.search_food, R.drawable.mn_org_map_ic_routing_food_off, R.string.category_food),
    ATM(R.id.search_atm, R.drawable.mn_org_map_ic_routing_atm_off, R.string.category_atm);
  ...
  private void toggleSearchLayout()
  {
    if (initSearchLayout())
    {
      ...
      if (mIsExpanded)
      {
        animRes = R.animator.mn_org_map_show_zoom_out_alpha;
      }
      else
      {
        animRes = R.animator.mn_org_map_show_zoom_in_alpha;
  ...
  private void resetSearchButtonImage()
  {
    mSearchButton.setImageDrawable(Graphics.tint(mSearchButton.getContext(),
                                                 R.drawable.mn_org_map_ic_search));
  }
  ...
  private void refreshSearchButtonImage()
  {
    ...
    mSearchButton.setImageDrawable(Graphics.tint(mSearchButton.getContext(),
                                                 searchOption == null ?
                                                 R.drawable.mn_org_map_ic_routing_search_off :
