...
import org.greenrobot.organicmaps.widget.recycler.SpanningLinearLayoutManager;
...
public class ToggleMapLayerFragment extends Fragment
{
  ...
  {
    View mRoot = inflater.inflate(R.layout.mn_org_map_fragment_toggle_map_layer, container, false);
