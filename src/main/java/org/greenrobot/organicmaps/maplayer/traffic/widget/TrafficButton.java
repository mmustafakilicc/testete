package org.greenrobot.organicmaps.maplayer.traffic.widget;
...
public class TrafficButton
{
  ...
  void turnOff()
  {
    ...
    mButton.setImageResource(ThemeUtils.isNightTheme(mButton.getContext()) ? R.drawable.mn_org_map_ic_traffic_on_night
                                                                           : R.drawable.mn_org_map_ic_traffic_on);
  }
  ...
  {
    stopWaitingAnimation();
    mButton.setImageResource(ThemeUtils.isNightTheme(mButton.getContext()) ? R.drawable.mn_org_map_ic_traffic_outdated_night
                                                                           : R.drawable.mn_org_map_ic_traffic_outdated);
  }
