...
import org.greenrobot.organicmaps.widget.menu.MyPositionButton;
...
public class MapButtonsController extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (layoutMode == LayoutMode.navigation)
            mFrame = inflater.inflate(R.layout.mn_org_map_map_buttons_layout_navigation, container, false);
        else if (layoutMode == LayoutMode.planning)
            mFrame = inflater.inflate(R.layout.mn_org_map_map_buttons_layout_planning, container, false);
        else
            mFrame = inflater.inflate(R.layout.mn_org_map_map_buttons_layout_regular, container, false);
        ...
        mInnerSearchView = mFrame.findViewById(R.id.etSearch);
        ...
        mInnerSearchView.setOnClickListener((v) -> mMapButtonClickListener.onMapButtonClick(MapButtons.search));
    ...
    private void updateMenuBadge(Boolean enable) {
        ...
        if (count == 0) {
            ...
            mBadgeDrawable.setBackgroundColor(getResources().getColor(R.color.mn_org_map_base_accent));
