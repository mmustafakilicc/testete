...
import org.greenrobot.organicmaps.editor.OpeningHours;
import org.greenrobot.organicmaps.editor.data.TimeFormatUtils;
import org.greenrobot.organicmaps.editor.data.Timespan;
...
import org.greenrobot.organicmaps.widget.placepage.PlacePageUtils;
...
public class PlacePageOpeningHoursFragment extends Fragment implements Observer<MapObject>
{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
  {
    ...
    return inflater.inflate(R.layout.mn_org_map_place_page_opening_hours_fragment, container, false);
  }
  ...
  private void refreshOpeningHours(MapObject mapObject)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          refreshTodayOpeningHours(resources.getString(R.string.day_off_today), ContextCompat.getColor(requireContext(), R.color.mn_org_map_base_red));
          UiUtils.hide(mTodayNonBusinessTime);
        }
      }
    }
