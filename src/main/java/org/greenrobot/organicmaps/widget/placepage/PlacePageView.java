...
import org.greenrobot.organicmaps.bookmarks.data.DistanceAndAzimut;
import org.greenrobot.organicmaps.bookmarks.data.MapObject;
import org.greenrobot.organicmaps.bookmarks.data.Metadata;
import org.greenrobot.organicmaps.downloader.CountryItem;
import org.greenrobot.organicmaps.downloader.DownloaderStatusIcon;
...
import org.greenrobot.organicmaps.util.SharedPrefUtils;
...
import org.greenrobot.organicmaps.widget.ArrowView;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePageBookmarkFragment;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePageLinksFragment;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePageOpeningHoursFragment;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePagePhoneFragment;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePageProductsFragment;
import org.greenrobot.organicmaps.widget.placepage.sections.PlacePageWikipediaFragment;
...

{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
  {
    ...
    return inflater.inflate(R.layout.mn_org_map_place_page, container, false);
  }
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    mCoordsFormat = CoordinatesFormat.fromId(SharedPrefUtils.INSTANCE.getCoordinateFormat(requireContext()));
  ...
  private void setTextAndColorizeSubtitle()
  {
    ...
    if (!TextUtils.isEmpty(text))
    {
      ...
      if (start > -1)
      {
        sb.setSpan(new ForegroundColorSpan(ContextCompat.getColor(requireContext(), R.color.mn_org_map_base_yellow)),
...
//    showTaxiOffer(mapObject);
    ...
    else
    {
      ...
      final int editPlaceButtonColor = Editor.nativeShouldEnableEditPlace() ? ContextCompat.getColor(getContext(), UiUtils.getStyledResourceId(getContext(), androidx.appcompat.R.attr.colorAccent)) : getResources().getColor(R.color.mn_org_map_button_accent_text_disabled);
  ...
  public void onClick(View v)
  {
    ...
    else if (id == R.id.ll__place_latlon)
    {
      ...
      SharedPrefUtils.INSTANCE.setCoordinateFormat(context, mCoordsFormat.getId());
      refreshLatLon();
    }
