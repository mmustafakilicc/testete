...
public final class PlacePageButtons extends Fragment implements Observer<List<PlacePageButtons.ButtonType>>
{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
  {
    ...
    return inflater.inflate(R.layout.mn_org_map_pp_buttons_fragment, container, false);
  }
  ...
  private View createButton(@NonNull final PlacePageButton current)
  {
    ...
    View parent = inflater.inflate(R.layout.mn_org_map_place_page_button, mButtonsContainer, false);
