...
import org.greenrobot.organicmaps.products.Product;
...
public class PlacePageProductsFragment extends Fragment
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_place_page_products_fragment, container, false);
  }
  ...
  private void updateView(@NonNull View view, @NonNull ProductsConfig config)
  {
    ...
    {
      var button = (Button) layoutInflater.inflate(R.layout.mn_org_map_item_product, productsButtons, false);
