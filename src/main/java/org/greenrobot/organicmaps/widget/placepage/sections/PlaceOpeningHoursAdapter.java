...
import static org.greenrobot.organicmaps.editor.data.TimeFormatUtils.formatNonBusinessTime;
import static org.greenrobot.organicmaps.editor.data.TimeFormatUtils.formatWeekdaysRange;
...
public class PlaceOpeningHoursAdapter extends RecyclerView.Adapter<PlaceOpeningHoursAdapter.ViewHolder>
{
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
  {
    return new ViewHolder(LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.mn_org_map_place_page_opening_hours_item, parent, false));
  }
