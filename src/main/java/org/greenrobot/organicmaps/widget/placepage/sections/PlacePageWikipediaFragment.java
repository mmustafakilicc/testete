...
import org.greenrobot.organicmaps.widget.placepage.PlaceDescriptionActivity;
...
public class PlacePageWikipediaFragment extends Fragment implements Observer<MapObject>
{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
  {
    ...
    return inflater.inflate(R.layout.mn_org_map_place_page_wikipedia_fragment, container, false);
  }
