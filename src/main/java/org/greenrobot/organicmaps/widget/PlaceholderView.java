...
public class PlaceholderView extends LinearLayout
{
  ...
  private void init(Context context, AttributeSet attrs)
  {
    ...
    inflater.inflate(R.layout.mn_org_map_placeholder_image, this, true);
    inflater.inflate(R.layout.mn_org_map_placeholder_title, this, true);
    inflater.inflate(R.layout.mn_org_map_placeholder_subtitle, this, true);
