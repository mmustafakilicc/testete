        ...
        if (image == null) {
            @DrawableRes int drawableRes = switch (mode) {
                case LocationState.PENDING_POSITION ->
                        R.drawable.mn_org_map_ic_menu_location_pending;
                case LocationState.NOT_FOLLOW_NO_POSITION -> R.drawable.mn_org_map_ic_location_off;
                case LocationState.NOT_FOLLOW -> R.drawable.mn_org_map_ic_not_follow;
                case LocationState.FOLLOW -> R.drawable.mn_org_map_ic_follow_new;
                case LocationState.FOLLOW_AND_ROTATE -> R.drawable.mn_org_map_ic_follow_and_rotate;
