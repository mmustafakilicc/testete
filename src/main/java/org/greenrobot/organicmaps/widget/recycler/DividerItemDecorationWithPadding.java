package org.greenrobot.organicmaps.widget.recycler;
...
import org.greenrobot.organicmaps.bookmarks.Holders;
...
public class DividerItemDecorationWithPadding extends RecyclerView.ItemDecoration
{
  ...
  {
    mDivider = Objects.requireNonNull(AppCompatResources.getDrawable(context, R.drawable.mn_org_map_divider_base));
