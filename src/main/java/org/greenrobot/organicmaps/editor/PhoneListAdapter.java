...
public class PhoneListAdapter extends RecyclerView.Adapter<PhoneListAdapter.ViewHolder>
{
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
  {
    return new ViewHolder(LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.mn_org_map_item_phone, parent, false));
  }
  ...
  protected class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
  {
    ...
    public ViewHolder(@NonNull View itemView)
    {
      ...
      deleteButton.setImageResource(R.drawable.mn_org_map_ic_delete);
      ((ImageView) itemView.findViewById(R.id.phone_icon)).setImageResource(R.drawable.mn_org_map_ic_phone);
    }
