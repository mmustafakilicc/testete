                                     ...
                                     TimetableProvider
{
  ...
  public BaseTimetableViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
  {
    ...
    return viewType == TYPE_TIMETABLE ? new TimetableViewHolder(inflater.inflate(R.layout.mn_org_map_item_timetable, parent, false))
                                      : new AddTimetableViewHolder(inflater.inflate(R.layout.mn_org_map_item_timetable_add, parent, false));
  }
    ...
    TimetableViewHolder(View itemView)
    {
      ...
      for (int i = 0; i < MAX_CLOSED_SPANS; i++)
      {
        final View span = LayoutInflater
            ...
            .inflate(R.layout.mn_org_map_item_timetable_closed_hours, closedHost, false);
