...
import org.greenrobot.organicmaps.editor.data.LocalizedName;
import org.greenrobot.organicmaps.editor.data.LocalizedStreet;
import org.greenrobot.organicmaps.editor.data.TimeFormatUtils;
import org.greenrobot.organicmaps.editor.data.Timetable;
import org.greenrobot.organicmaps.util.Graphics;
import org.greenrobot.organicmaps.util.InputUtils;
import org.greenrobot.organicmaps.util.StringUtils;
...
public class EditorFragment extends BaseMwmFragment implements View.OnClickListener
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_fragment_editor, container, false);
  }
  ...
  private void initViews(View view)
  {
    ...
    mHouseNumber = findInputAndInitBlock(blockHouseNumber, R.drawable.mn_org_map_ic_building, R.string.house_number);
    mInputHouseNumber = blockHouseNumber.findViewById(R.id.custom_input);

    initBlock(view, Metadata.MetadataType.FMD_POSTCODE, R.id.block_zipcode, R.drawable.mn_org_map_ic_address, R.string.editor_zip_code, 0);

    // Details
    View mBlockLevels = view.findViewById(R.id.block_levels);
    mBuildingLevels = findInputAndInitBlock(mBlockLevels, R.drawable.mn_org_map_ic_floor,
    ...
    View websiteBlock = initBlock(view, Metadata.MetadataType.FMD_WEBSITE, R.id.block_website,
            R.drawable.mn_org_map_ic_website, R.string.website, InputType.TYPE_TEXT_VARIATION_URI);
    View websiteMenuBlock = initBlock(view, Metadata.MetadataType.FMD_WEBSITE_MENU, R.id.block_website_menu,
            R.drawable.mn_org_map_ic_website_menu, R.string.website_menu, InputType.TYPE_TEXT_VARIATION_URI);
    View emailBlock = initBlock(view, Metadata.MetadataType.FMD_EMAIL, R.id.block_email,
            R.drawable.mn_org_map_ic_email, R.string.email, InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS);
    View facebookContactBlock = initBlock(view, Metadata.MetadataType.FMD_CONTACT_FACEBOOK, R.id.block_facebook,
            R.drawable.mn_org_map_ic_facebook_white, R.string.facebook, InputType.TYPE_TEXT_VARIATION_URI);
    View instagramContactBlock = initBlock(view, Metadata.MetadataType.FMD_CONTACT_INSTAGRAM, R.id.block_instagram,
            R.drawable.mn_org_map_ic_instagram_white, R.string.instagram, InputType.TYPE_TEXT_VARIATION_URI);
    View twitterContactBlock = initBlock(view, Metadata.MetadataType.FMD_CONTACT_TWITTER, R.id.block_twitter,
            R.drawable.mn_org_map_ic_twitterx_white, R.string.twitter, InputType.TYPE_TEXT_VARIATION_URI);
    View vkContactBlock = initBlock(view, Metadata.MetadataType.FMD_CONTACT_VK, R.id.block_vk,
            R.drawable.mn_org_map_ic_vk_white, R.string.vk, InputType.TYPE_TEXT_VARIATION_URI);
    View lineContactBlock = initBlock(view, Metadata.MetadataType.FMD_CONTACT_LINE, R.id.block_line,
            R.drawable.mn_org_map_ic_line_white, R.string.editor_line_social_network, InputType.TYPE_TEXT_VARIATION_URI);
    View operatorBlock = initBlock(view, Metadata.MetadataType.FMD_OPERATOR, R.id.block_operator,
            R.drawable.mn_org_map_ic_operator, R.string.editor_operator, 0);
  ...
  private void refreshNamesCaption()
  {
    if (mNamesAdapter.getNamesCount() <= mNamesAdapter.getMandatoryNamesCount())
      ...
      setNamesArrow(R.drawable.mn_org_map_ic_expand_less);
    else
      setNamesArrow(R.drawable.mn_org_map_ic_expand_more);
