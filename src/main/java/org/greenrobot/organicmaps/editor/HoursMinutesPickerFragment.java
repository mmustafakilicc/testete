...
import org.greenrobot.organicmaps.util.DateUtils;
...
public class HoursMinutesPickerFragment extends BaseMwmDialogFragment
{
  ...
  private View createView()
  {
    ...
    final View root = inflater.inflate(R.layout.mn_org_map_fragment_timetable_picker, null);
    ...
    TextView tabView = (TextView) inflater.inflate(R.layout.mn_org_map_tab_timepicker, mTabs, false);
    ...
    final ColorStateList textColor = AppCompatResources.getColorStateList(requireContext(),
        ThemeUtils.isNightTheme(requireContext()) ? R.color.mn_org_map_accent_color_selector_night
                                                  : R.color.mn_org_map_accent_color_selector);
    tabView.setTextColor(textColor);
    mTabs.addTab(mTabs.newTab().setCustomView(tabView), true);
    tabView = (TextView) inflater.inflate(R.layout.mn_org_map_tab_timepicker, mTabs, false);
