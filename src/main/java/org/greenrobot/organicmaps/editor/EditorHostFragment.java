...
import org.greenrobot.organicmaps.base.BaseMwmToolbarFragment;
...
import org.greenrobot.organicmaps.editor.data.NamesDataSource;
import org.greenrobot.organicmaps.editor.data.PhoneFragment;
...
public class EditorHostFragment extends BaseMwmToolbarFragment implements View.OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.mn_org_map_fragment_editor_host, container, false);
    }
        ...
        if (v.getId() == R.id.save) {
            switch (mMode) {
                ...
                case MAP_OBJECT -> {
                    ...
                    // Save object edits
                    if (!SharedPrefUtils.INSTANCE.isNoobAlertShown(requireContext())) {
                        showNoobDialog();
                    } else {
                        saveNote();
                        saveMapObjectEdits();
    ...
    private void showNoobDialog() {
        new MaterialAlertDialogBuilder(requireActivity(), R.style.MwmTheme_AlertDialog)
                ...
                .setPositiveButton(android.R.string.ok, (dlg, which) -> {
                    SharedPrefUtils.INSTANCE.noobAlertShown(requireContext());
                    saveNote();
                    saveMapObjectEdits();
                })
