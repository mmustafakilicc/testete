                                       ...
                                       implements View.OnClickListener, TimetableProvider
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_fragment_timetable_advanced, container, false);
  }
  ...
  private void initViews(View view)
  {
    ...
    setExampleDrawables(R.drawable.mn_org_map_ic_type_text, R.drawable.mn_org_map_ic_expand_more);
  ...
  private void showExample(boolean show)
  {
    ...
    if (mIsExampleShown)
    {
      ...
      setExampleDrawables(R.drawable.mn_org_map_ic_type_text, R.drawable.mn_org_map_ic_expand_less);
    }
    else
    {
