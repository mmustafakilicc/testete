package org.greenrobot.organicmaps.editor.data;
...
import org.greenrobot.organicmaps.editor.PhoneListAdapter;
...
public class PhoneFragment extends BaseMwmFragment implements View.OnClickListener
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_fragment_phone, container, false);
  }
