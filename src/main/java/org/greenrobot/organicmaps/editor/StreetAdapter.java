...
public class StreetAdapter extends RecyclerView.Adapter<StreetAdapter.BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return viewType == TYPE_STREET ? new StreetViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.mn_org_map_item_street, parent, false))
                : new AddViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.mn_org_map_item_add_street, parent, false));
    }
    ...
    private void addStreet() {
        final Resources resources = OrganicMapsModule.get().getApplication().getResources();
