...
public enum ThemeSwitcher
{
  ...
  private final Runnable mAutoThemeChecker = new Runnable()
  {
    ...
    public void run()
    {
      String nightTheme = OrganicMapsModule.get().getApplication().getString(R.string.mn_org_map_theme_night);
  ...
  private void setThemeAndMapStyle(@NonNull String theme)
  {
    ...
    if (!theme.equals(oldTheme))
    {
      ...
      final Activity a = OrganicMapsModule.get().getTopActivity();
  ...
  private void SetMapStyle(@Framework.MapStyle int style)
  {
    ...
    // For the Android Auto theme switcher, please consult the org.greenrobot.organicmaps.car.util.ThemeUtils module.
