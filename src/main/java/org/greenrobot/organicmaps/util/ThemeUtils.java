...
public final class ThemeUtils
{
  ...
  {
    String defaultTheme = context.getString(R.string.mn_org_map_theme_default);
  ...
  {
    String nightTheme = context.getString(R.string.mn_org_map_theme_night);
  ...
  {
    String autoTheme = context.getString(R.string.mn_org_map_theme_auto);
  ...
  {
    String navAutoTheme = context.getString(R.string.mn_org_map_theme_nav_auto);
