...
public class Utils
{
  ...
  {
    return OrganicMapsModule.Companion.getAppVersionName();
  }
  ...
  public static int getIntVersion()
  {
    ...
    return (OrganicMapsModule.Companion.getAppVersionCode() % 1_00_00_00_00) / 100;
  }
  ...
  private static class SupportInfoWithLogsCallback implements LogsManager.OnZipCompletedListener
  {
    ...
    public void onCompleted(final boolean success, @Nullable final String zipPath)
    {
      ...
      UiThread.run(() -> {
        ...
        info.mMail = mEmail;
        info.mSubject = "[" + OrganicMapsModule.Companion.getAppVersionName() + "] " + mSubject;
        info.mText = mBody;
