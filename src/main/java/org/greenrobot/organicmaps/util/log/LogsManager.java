package org.greenrobot.organicmaps.util.log;
...
import org.greenrobot.organicmaps.BuildConfig;
import org.greenrobot.organicmaps.OrganicMapsModule;
import org.greenrobot.organicmaps.R;
import org.greenrobot.organicmaps.util.ROMUtils;
...
public final class LogsManager {
    ...
    public synchronized void initFileLogging(@NonNull Application application) {
        ...
        mIsFileLoggingEnabled = SharedPrefUtils.INSTANCE.getPref(application).getBoolean(mApplication.getString(R.string.mn_org_map_pref_enable_logging), false);
    ...
    private void switchFileLoggingEnabled(boolean enabled) {
        ...
        if (mApplication != null) {
            SharedPrefUtils.INSTANCE.getPref(mApplication)
                    .edit()
                    .putBoolean(mApplication.getString(R.string.mn_org_map_pref_enable_logging), enabled)
                    .apply();
        }
    ...
    String getSystemInformation() {
        ...
        sb.append("\nApp version: ").append(OrganicMapsModule.Companion.getApplicationId()).append(' ').append(OrganicMapsModule.Companion.getAppVersionName())
