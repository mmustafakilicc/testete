package org.greenrobot.organicmaps.dialog;
...
public class EditTextDialogFragment extends BaseMwmDialogFragment
{
  ...
  {
    @SuppressLint("InflateParams") final View root = requireActivity().getLayoutInflater().inflate(R.layout.mn_org_map_dialog_edit_text, null);
