...
import org.greenrobot.organicmaps.bookmarks.data.ElevationInfo;
import org.greenrobot.organicmaps.util.ThemeUtils;
import org.greenrobot.organicmaps.util.Utils;
import org.greenrobot.organicmaps.widget.placepage.AxisValueFormatter;
import org.greenrobot.organicmaps.widget.placepage.CurrentLocationMarkerView;
import org.greenrobot.organicmaps.widget.placepage.FloatingMarkerView;
                                        ...
                                        BookmarkManager.OnElevationCurrentPositionChangedListener
{
  ...
  private void initAxises()
  {
    ...
    y.setGridColor(ContextCompat.getColor(mContext, R.color.mn_org_map_black_12));
    y.setEnabled(true);
  ...
  public void setData(@NonNull ElevationInfo info)
  {
    ...
    set.setHighLightColor(ContextCompat.getColor(mContext, R.color.mn_org_map_base_accent_transparent));
