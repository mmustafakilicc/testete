...
class DownloaderAdapter extends RecyclerView.Adapter<DownloaderAdapter.ViewHolderWrapper>
{
  ...
  private View createViewHolderFrame(ViewGroup parent, int kind)
  {
    if (kind == TYPE_COUNTRY)
      return inflate(parent, R.layout.mn_org_map_downloader_item);
    else
      return inflate(parent, R.layout.mn_org_map_downloader_item_header);
  ...
  {
    return new MenuBottomSheetItem(R.string.downloader_download_map, R.drawable.mn_org_map_ic_download,
                                   () -> onDownloadActionSelected(mSelectedItem, DownloaderAdapter.this));
  }

  private MenuBottomSheetItem getUpdateMenuItem()
  {
    return new MenuBottomSheetItem(R.string.downloader_update_map, R.drawable.mn_org_map_ic_update,
                                   () -> onUpdateActionSelected(mSelectedItem, DownloaderAdapter.this));
  }

  private MenuBottomSheetItem getExploreMenuItem()
  {
    return new MenuBottomSheetItem(R.string.zoom_to_country, R.drawable.mn_org_map_ic_explore,
  ...
  private void appendDeleteMenuItem(ArrayList<MenuBottomSheetItem> items)
  {
    ...
    {
      items.add(new MenuBottomSheetItem(R.string.delete, R.drawable.mn_org_map_ic_delete,
  ...
  {
    return new MenuBottomSheetItem(R.string.cancel, R.drawable.mn_org_map_ic_cancel,
