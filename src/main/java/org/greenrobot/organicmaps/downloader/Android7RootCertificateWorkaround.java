...
public class Android7RootCertificateWorkaround
{
  ...
  public static void initializeIfNeeded(Context context)
  {
    ...
    final int[] certificates = new int[]{
        R.raw.mn_org_map_isrgrootx1, R.raw.mn_org_map_globalsignr4, R.raw.mn_org_map_gtsrootr1, R.raw.mn_org_map_gtsrootr2, R.raw.mn_org_map_gtsrootr3, R.raw.mn_org_map_gtsrootr4};
