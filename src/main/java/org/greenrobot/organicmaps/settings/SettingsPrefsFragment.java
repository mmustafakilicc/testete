...
import org.greenrobot.organicmaps.editor.LanguagesFragment;
import org.greenrobot.organicmaps.editor.OsmOAuth;
import org.greenrobot.organicmaps.editor.ProfileActivity;
import org.greenrobot.organicmaps.editor.data.Language;
import org.greenrobot.organicmaps.location.LocationHelper;
import org.greenrobot.organicmaps.location.LocationProviderFactory;
import org.greenrobot.organicmaps.routing.RoutingOptions;
import org.greenrobot.organicmaps.sdk.search.SearchRecents;
import org.greenrobot.organicmaps.util.Config;
import org.greenrobot.organicmaps.util.NetworkPolicy;
...
public class SettingsPrefsFragment extends BaseXmlSettingsFragment implements LanguagesFragment.Listener
{
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_tts_screen));
    pref.setSummary(Config.TTS.isEnabled() ? R.string.on : R.string.off);
  }

  private void updateMapLanguageCodeSummary()
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_map_locale));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_prefs_routing));
    pref.setSummary(RoutingOptions.hasAnyOptions() ? R.string.on : R.string.off);
  }

  private void updateProfileSettingsPrefsSummary()
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_osm_profile));
  ...
  public boolean onPreferenceTreeClick(Preference preference)
  {
    ...
    if (key != null)
    {
      if (key.equals(getString(R.string.mn_org_map_pref_osm_profile)))
      {
        startActivity(new Intent(requireActivity(), ProfileActivity.class));
      }
      else if (key.equals(getString(R.string.mn_org_map_pref_tts_screen)))
      {
        getSettingsActivity().stackFragment(VoiceInstructionsSettingsFragment.class, getString(R.string.pref_tts_enable_title), null);
      }
      else if (key.equals(getString(R.string.mn_org_map_pref_map_locale)))
      {
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_large_fonts_size));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_transliteration));
  ...
  {
    final ListPreference mobilePref = getPreference(getString(R.string.mn_org_map_pref_use_mobile_data));
  ...
  {
    final ListPreference powerManagementPref = getPreference(getString(R.string.mn_org_map_pref_power_management));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_enable_logging));
  ...
  {
    final Preference pref = findPreference(getString(R.string.mn_org_map_pref_emulate_bad_external_storage));
    if (pref == null)
      return;

    if (!SharedPropertiesUtils.shouldShowEmulateBadStorageSetting(requireContext()))
      removePreference(getString(R.string.mn_org_map_pref_settings_general), pref);
    else
  ...
  {
    final TwoStatePreference pref = getPreference(getString(R.string.mn_org_map_pref_auto_zoom));
  ...
  {
    final Preference pref = findPreference(getString(R.string.mn_org_map_pref_play_services));
    if (pref == null)
      return;

    if (!LocationProviderFactory.isGoogleLocationAvailable(requireActivity().getApplicationContext()))
      removePreference(getString(R.string.mn_org_map_pref_privacy), pref);
    else
    {
  ...
  {
    final Preference pref = findPreference(getString(R.string.mn_org_map_pref_search_history));
    if (pref == null)
      return;
  ...
  {
    final TwoStatePreference pref = getPreference(getString(R.string.mn_org_map_pref_display_kayak));
  ...
  {
    final TwoStatePreference pref = getPreference(getString(R.string.mn_org_map_pref_3d_buildings));
  ...
  {
    final TwoStatePreference pref = getPreference(getString(R.string.mn_org_map_pref_3d));
  ...
  {
    final TwoStatePreference pref = getPreference(getString(R.string.mn_org_map_pref_autodownload));
  ...
  {
    final ListPreference pref = getPreference(getString(R.string.mn_org_map_pref_map_style));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_show_zoom_buttons));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_munits));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_storage));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_keep_screen_on));
  ...
  {
    final Preference pref = getPreference(getString(R.string.mn_org_map_pref_show_on_lock_screen));
  ...
  enum ThemeMode
  {
    DEFAULT(R.string.mn_org_map_theme_default),
    NIGHT(R.string.mn_org_map_theme_night),
    AUTO(R.string.mn_org_map_theme_auto),
    NAV_AUTO(R.string.mn_org_map_theme_nav_auto);
