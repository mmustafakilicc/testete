...
import org.greenrobot.organicmaps.sound.LanguageData;
...
public class VoiceInstructionsSettingsFragment extends BaseXmlSettingsFragment
{
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
  {
    ...
    mTtsPrefEnabled = getPreference(getString(R.string.mn_org_map_pref_tts_enabled));
    mTtsPrefLanguages = getPreference(getString(R.string.mn_org_map_pref_tts_language));
    mTtsPrefStreetNames = findPreference(getString(R.string.mn_org_map_pref_tts_street_names));
    mTtsLangInfo = getPreference(getString(R.string.mn_org_map_pref_tts_info));
    ...
    mTtsVoiceTest = getPreference(getString(R.string.mn_org_map_pref_tts_test_voice));
  ...
  {
    mTtsVolume = getPreference(getString(R.string.mn_org_map_pref_tts_volume));
  ...
  {
    final ListPreference pref = getPreference(getString(R.string.mn_org_map_pref_tts_speed_cameras));
