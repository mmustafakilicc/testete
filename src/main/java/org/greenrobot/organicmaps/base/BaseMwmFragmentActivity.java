...
import org.greenrobot.organicmaps.InitialActivity;
...
import org.greenrobot.organicmaps.util.RtlUtils;
...
public abstract class BaseMwmFragmentActivity extends AppCompatActivity {
    ...
    protected final void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!OrganicMapsModule.get().arePlatformAndCoreInitialized()) {
            ...
            intent.setComponent(new ComponentName(this, InitialActivity.class));
