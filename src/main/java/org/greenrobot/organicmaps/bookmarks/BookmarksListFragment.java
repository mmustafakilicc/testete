...
import org.greenrobot.organicmaps.bookmarks.data.BookmarkInfo;
import org.greenrobot.organicmaps.bookmarks.data.BookmarkManager;
import org.greenrobot.organicmaps.bookmarks.data.BookmarkSharingResult;
import org.greenrobot.organicmaps.bookmarks.data.CategoryDataSource;
import org.greenrobot.organicmaps.bookmarks.data.Icon;
import org.greenrobot.organicmaps.bookmarks.data.KmlFileType;
import org.greenrobot.organicmaps.bookmarks.data.SortedBlock;
import org.greenrobot.organicmaps.bookmarks.data.Track;
import org.greenrobot.organicmaps.location.LocationHelper;
import org.greenrobot.organicmaps.sdk.search.BookmarkSearchListener;
import org.greenrobot.organicmaps.sdk.search.SearchEngine;
import org.greenrobot.organicmaps.util.Graphics;
...
import org.greenrobot.organicmaps.widget.placepage.BookmarkColorDialogFragment;
import org.greenrobot.organicmaps.widget.placepage.EditBookmarkFragment;
import org.greenrobot.organicmaps.widget.recycler.DividerItemDecorationWithPadding;
               ...
               MenuBottomSheetFragment.MenuBottomSheetInterface
{
  ...
  {
    return inflater.inflate(R.layout.mn_org_map_fragment_bookmark_list, container, false);
  }
  ...
  {
    inflater.inflate(R.menu.mn_org_map_option_menu_bookmarks, menu);
  ...
  public void onPrepareOptionsMenu(@NonNull Menu menu)
  {
    ...
    if (mLastSortTimestamp != 0)
      itemMore.setActionView(R.layout.mn_org_map_toolbar_menu_progressbar);
  }
  ...
  private ArrayList<MenuBottomSheetItem> getOptionsMenuItems()
  {
    ...
    {
      if (types.length > 0)
        items.add(new MenuBottomSheetItem(R.string.sort, R.drawable.mn_org_map_ic_sort, this::onSortOptionSelected));
      items.add(new MenuBottomSheetItem(R.string.export_file, R.drawable.mn_org_map_ic_file_kmz, () -> onShareOptionSelected(KmlFileType.Text)));
      items.add(new MenuBottomSheetItem(R.string.export_file_gpx, R.drawable.mn_org_map_ic_file_gpx, () -> onShareOptionSelected(KmlFileType.Gpx)));
    }
    items.add(new MenuBottomSheetItem(R.string.edit, R.drawable.mn_org_map_ic_settings, this::onSettingsOptionSelected));
    if (!isLastOwnedCategory())
      items.add(new MenuBottomSheetItem(R.string.delete_list, R.drawable.mn_org_map_ic_delete, this::onDeleteOptionSelected));
    return items;
  }
  ...
  {
    ArrayList<MenuBottomSheetItem> items = new ArrayList<>();
    items.add(new MenuBottomSheetItem(R.string.share, R.drawable.mn_org_map_ic_share, this::onShareActionSelected));
    items.add(new MenuBottomSheetItem(R.string.edit, R.drawable.mn_org_map_ic_edit, this::onEditActionSelected));
    items.add(new MenuBottomSheetItem(R.string.delete, R.drawable.mn_org_map_ic_delete, this::onDeleteActionSelected));
    return items;
  }
  ...
  {
    ArrayList<MenuBottomSheetItem> items = new ArrayList<>();
    items.add(new MenuBottomSheetItem(R.string.edit, R.drawable.mn_org_map_ic_edit, this::onTrackEditActionSelected));
    items.add(new MenuBottomSheetItem(R.string.export_file, R.drawable.mn_org_map_ic_file_kmz, () -> onShareTrackSelected(track.getTrackId(), KmlFileType.Text)));
    items.add(new MenuBottomSheetItem(R.string.export_file_gpx, R.drawable.mn_org_map_ic_file_gpx, () -> onShareTrackSelected(track.getTrackId(), KmlFileType.Gpx)));
    items.add(new MenuBottomSheetItem(R.string.delete, R.drawable.mn_org_map_ic_delete, () -> onDeleteTrackSelected(track.getTrackId())));
    return items;
  }
