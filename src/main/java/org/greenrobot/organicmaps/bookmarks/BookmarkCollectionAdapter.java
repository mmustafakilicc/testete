...
public class BookmarkCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
                                                    ...
                                                    @SectionType int viewType)
  {
    ...
    if (viewType == TYPE_HEADER_ITEM)
      holder = new Holders.HeaderViewHolder(inflater.inflate(R.layout.mn_org_map_item_bookmark_group_list_header,
                                                             parent, false));
    if (viewType == TYPE_CATEGORY_ITEM)
      holder = new Holders.CollectionViewHolder(inflater.inflate(R.layout.mn_org_map_item_bookmark_collection,
                                                                 parent, false));
