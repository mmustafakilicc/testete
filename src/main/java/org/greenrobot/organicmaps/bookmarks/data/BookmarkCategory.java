...
public class BookmarkCategory implements Parcelable
{
  ...
  {
    ACCESS_RULES_LOCAL(R.string.not_shared, R.drawable.mn_org_map_ic_lock),
    ACCESS_RULES_PUBLIC(R.string.public_access, R.drawable.mn_org_map_ic_public_inline),
    ACCESS_RULES_DIRECT_LINK(R.string.limited_access, R.drawable.mn_org_map_ic_link_inline),
    ACCESS_RULES_AUTHOR_ONLY(R.string.access_rules_author_only, R.drawable.mn_org_map_ic_lock);
