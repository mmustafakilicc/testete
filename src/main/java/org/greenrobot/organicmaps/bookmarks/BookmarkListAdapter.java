...
import org.greenrobot.organicmaps.bookmarks.data.IconClickListener;
import org.greenrobot.organicmaps.bookmarks.data.SortedBlock;
import org.greenrobot.organicmaps.content.DataSource;
import org.greenrobot.organicmaps.widget.recycler.RecyclerClickListener;
import org.greenrobot.organicmaps.widget.recycler.RecyclerLongClickListener;
    ...
    switch (viewType)
    {
      case TYPE_TRACK:
        Holders.TrackViewHolder trackHolder =
            new Holders.TrackViewHolder(inflater.inflate(R.layout.mn_org_map_item_track, parent,
                                                         false));
      ...
      case TYPE_BOOKMARK:
        Holders.BookmarkViewHolder bookmarkHolder =
            new Holders.BookmarkViewHolder(inflater.inflate(R.layout.mn_org_map_item_bookmark, parent,
                                                            false));
        ...
        break;
      case TYPE_SECTION:
        TextView tv = (TextView) inflater.inflate(R.layout.mn_org_map_item_category_title, parent, false);
        holder = new Holders.SectionViewHolder(tv);
        break;
      case TYPE_DESC:
        View desc = inflater.inflate(R.layout.mn_org_map_item_category_description, parent, false);
