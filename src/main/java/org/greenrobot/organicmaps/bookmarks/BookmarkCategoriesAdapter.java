...
import static org.greenrobot.organicmaps.bookmarks.Holders.CategoryViewHolder;
import static org.greenrobot.organicmaps.bookmarks.Holders.HeaderViewHolder;
...
import org.greenrobot.organicmaps.adapter.OnItemClickListener;
...
public class BookmarkCategoriesAdapter extends BaseBookmarkCategoryAdapter<RecyclerView.ViewHolder>
{
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
  {
    ...
    switch (viewType)
    {
      ...
      {
        View header = inflater.inflate(R.layout.mn_org_map_item_bookmark_group_list_header, parent, false);
        return new HeaderViewHolder(header);
      }
      case TYPE_CATEGORY_ITEM ->
      {
        View view = inflater.inflate(R.layout.mn_org_map_item_bookmark_category, parent, false);
      ...
      {
        View item = inflater.inflate(R.layout.mn_org_map_item_bookmark_button, parent, false);
  ...
  public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position)
  {
    ...
    switch (type)
    {
      ...
      case TYPE_ACTION_ADD ->
      {
        ...
        generalViewHolder.getImage().setImageResource(R.drawable.mn_org_map_ic_add_list);
        generalViewHolder.getText().setText(R.string.bookmarks_create_new_group);
      }
      case TYPE_ACTION_IMPORT ->
      {
        Holders.GeneralViewHolder generalViewHolder = (Holders.GeneralViewHolder) holder;
        generalViewHolder.getImage().setImageResource(R.drawable.mn_org_map_ic_import);
        generalViewHolder.getText().setText(R.string.bookmarks_import);
      }
      case TYPE_ACTION_EXPORT_ALL_AS_KMZ ->
      {
        Holders.GeneralViewHolder generalViewHolder = (Holders.GeneralViewHolder) holder;
        generalViewHolder.getImage().setImageResource(R.drawable.mn_org_map_ic_export);
